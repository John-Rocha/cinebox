...
class TmdbRepositoryImpl implements TmdbRepository {
  ...
  Future<Result<List<Movie>>> getPopularMovies({
    ...
    try {
      ...
      return Success(value: MovieMappers.mapToMovies(moviesData));
    } on DioException catch (e, s) {
      log('Erro ao buscar getPopularMovies', error: e, stackTrace: s);
      return Failure(
        error: DataExceptions(message: 'Erro ao buscar os filmes populares'),
      );
    }
  }
  ...
  Future<Result<List<Genre>>> getGenres() async {
    try {
      ...
      final genres = data.genres
          ...
          .toList();
      return Success(value: genres);
    } on DioException catch (e, s) {
      log('Erro ao buscar generos', error: e, stackTrace: s);
      return Failure(error: DataExceptions(message: 'Erro ao buscar generos'));
    }
  }
  ...
  Future<Result<List<Movie>>> getMoviesByGenres({required int genreId}) async {
    try {
      ...
      return Success(value: MovieMappers.mapToMovies(data));
    } on DioException catch (e, s) {
      log('Erro ao buscar filmes por genero', error: e, stackTrace: s);
      return Failure(
        error: DataExceptions(message: 'Erro ao buscar filmes por genero'),
      );
    }
  }
  ...
  Future<Result<List<Movie>>> searchMovies({required String query}) async {
    try {
      ...
      return Failure(
        error: DataExceptions(message: 'Erro ao buscar filmes por nome'),
      );
    }
  }
  ...
  Future<Result<MovieDetail>> getMovieDetail(int movieId) async {
    ...
    return Success(value: movieDetail);
  }
}
